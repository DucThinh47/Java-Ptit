...
public class NhanVien {
    ...
    public NhanVien(String ten, long luong_co_ban, int so_ngay_cong, String chuc_vu){
        ...
        }else if(this.so_ngay_cong >= 22 && this.so_ngay_cong < 25){
            this.tien_thuong = (this.luong_thang * 10) / 100;
        }else{
            this.tien_thuong = 0;
        }
        if(this.chuc_vu.compareTo("GD") == 0){
            this.phu_cap = 250000;
        }else if(this.chuc_vu.compareTo("PGD") == 0){
            this.phu_cap = 200000;
        }else if(this.chuc_vu.compareTo("TP") == 0){
            this.phu_cap = 180000;
        }else{
            this.phu_cap = 150000;
        }
