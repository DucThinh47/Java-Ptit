...
public class SanPham{
    ...
    public SanPham(String ten, int so_luong, int don_gia){
        ...
        if(so_luong > 10){
            this.tien_chiet_khau = don_gia * so_luong * 5 / 100;
        }else if(so_luong >= 8 && so_luong <= 10){
            this.tien_chiet_khau = don_gia * so_luong * 2 / 100;
        }else if(so_luong >= 5 && so_luong < 8){
            this.tien_chiet_khau = don_gia * so_luong * 1 / 100;
        }else{
    ...
    public String toString(){
        return this.ma + " " + this.ten + " " + this.tien_chiet_khau + " " + (this.don_gia * this.so_luong - this.tien_chiet_khau);
    }
}