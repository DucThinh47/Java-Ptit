...
public class NhanVien {
    ...
    private long luong_thang, thuong, phu_cap, thu_nhap;
    ...
    public NhanVien(String ten, long luong_co_ban, int so_ngay_cong, String chuc_vu){
        ...
        this.thu_nhap = this.luong_thang + this.thuong + this.phu_cap;
    }
    
    @Override
    public String toString(){
        return this.ma + " " + this.ten + " " + this.luong_thang + " " + this.thuong + " " + this.phu_cap + " " + this.thu_nhap;
    }
}
